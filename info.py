...
AUTH_CHANNEL1 = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('AUTH_CHANNEL1', '-1001860172104 -1002548721158').split()] # give channel id with seperate space. Ex : ('-10073828 -102782829 -1007282828')
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002314687215 -1002548721158'))
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+8_9Ycm-CPpUxNWY1')
